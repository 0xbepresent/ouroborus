...
def validate_and_exit_on_error() -> None:
    ...
    Raises:
        ...
        OuroborusError: If Logging configuration is invalid
    """
    from src.utils.exceptions import LLMConfigError, CodeQLConfigError, OuroborusError
    ...
    if not is_valid:
        ...
        if has_llm_error:
            ...
            raise OuroborusError(errors_block)
        else:
            raise OuroborusError(errors_block)
