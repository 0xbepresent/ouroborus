...
example.py
----------
Example usage of Ouroborus - demonstrates a full pipeline run for multiple repositories.
...
def main():
    """
    Run an end-to-end example of the Ouroborus pipeline for multiple repositories.
    ...
    # Initialize logging
    setup_logging()
    logger.info("Starting Ouroborus pipeline example... This may take a few minutes.")
    logger.info("")
