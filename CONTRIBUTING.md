# Contributing to Ouroborus

Thank you for your interest in contributing to Ouroborus! We are always delighted to welcome new contributors!
...
If you have found a bug, please raise an issue on the Ouroborus repository.

## Found a Vulnerability?

If you think you have found a vulnerability in Ouroborus, please refer to [Security](SECURITY.md)
...
Ouroborus uses centralized logging. Always use `get_logger(__name__)` instead of `print()` for application messages.
